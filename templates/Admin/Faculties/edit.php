    ...
    <div class="col-2 text-end">
        <div class="dropdown mx-3 mt-2">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="orderStatistics">
                ...
                <?= $this->Html->link(__('List Faculties'), ['action' => 'index'], ['class' => 'dropdown-item']) ?>
            </div>
        </div>
    </div>
</div>
...
<div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow-sm">
    <div class="card-body text-body-secondary">
        <?= $this->Form->create($faculty, ['class' => 'needs-validation', 'novalidate' => true]) ?>
        <fieldset>
            <legend class="text-primary mb-4"><?= __('Edit Faculty') ?></legend>

            <!-- Form Fields -->
            <div class="row g-3">
                <div class="col-md-6">
                    <?= $this->Form->control('name', ['label' => 'Faculty Name', 'class' => 'form-control']); ?>
                </div>
                <div class="col-md-6">
