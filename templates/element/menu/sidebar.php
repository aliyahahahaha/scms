    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Activities' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-folder-closed"></i> Activities'), ['controller' => 'Activities', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Faculties' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-school"></i> Faculties'), ['prefix' => 'Admin', 'controller' => 'Faculties', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Programs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-book"></i> Programs'), ['prefix' => 'Admin', 'controller' => 'Programs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Semesters' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-chart-pie"></i> Semesters'), ['prefix' => 'Admin', 'controller' => 'Semesters', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Clubs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-puzzle-piece"></i> Clubs'), ['prefix' => 'Admin', 'controller' => 'Clubs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
            
                        </li>
                    <li class="menu-item <?= $c_name == 'Activities' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-folder-closed"></i> Activities'), ['prefix' => 'Admin', 'controller' => 'Activities', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>                   </li>
